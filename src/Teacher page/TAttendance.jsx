...
function TAttendance({ onCancelClick }) {
  ...
  const absent = [{ value: "1", label: "All" }];
  const present = [{ value: "1", label: "All" }];
  ...
  return (
    <div>
      ...
      <div
        className="flex flex-col sm:flex-row justify-center sm:justify-start mt-8 md:mt-5 items-center "
        style={{ top: "0px", right: "30px" }}
      >
        <div className="justify-start items-start sm:justify-center sm:items-center">
          <h1
            className="text-2xl font-serif font-italian pl-2"
            style={{ color: "#079440", fontSize: "50px" }}
          >
            ATTENDANCE
          </h1>
        </div>
      ...
      <div
        className="flex flex-col sm:flex-row justify-center sm:justify-end mt-20 md:mt-100 items-center "
        style={{ top: "20px", right: "20px" }}
      >
        <Dropdown
          options={sy}
          label={<span style={{ fontWeight: "bold" }}>School Year</span>}
          sx={{ outline: "4px solid black" }}
        />
        <Dropdown
          options={gradelevel}
          label={<span style={{ fontWeight: "bold" }}>Grade level</span>}
          sx={{ outline: "4px solid black" }}
        />
        <Dropdown
          options={sections}
        ...
        <Dropdown
          options={present}
          label={<span style={{ fontWeight: "bold" }}>Present</span>}
          sx={{ outline: "4px solid black" }}
        />
        <Dropdown
          options={absent}
          label={<span style={{ fontWeight: "bold" }}>Absent</span>}
          sx={{ outline: "4px solid black" }}
        />
      </div>
      ...
      >
        <div
          className="flex items-center justify-center rounded-lg px-2 py-2 lg:w-auto"
          style={{
        ...
        >
          ...
          <h1 className="text-l font-serif px-1" style={{ color: "#079440" }}>
            Monthly Report
          </h1>
        </div>
      </div>

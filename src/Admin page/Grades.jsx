...
import StudGrades from "./StudGrades";
...
function Grades({ onCancelClick }) {
  ...
  // Redirect to StudGrades component if viewId is set
  if (viewId !== null) {
    return <StudGrades id={viewId} onCancelClick={() => setViewId(null)} />;
  }
  ...
  return (
    <div>
      ...
      <div data-aos="fade-right">
        <GradeTable onViewClick={handleViewClick} />
      </div>
    </div>
  );
}
